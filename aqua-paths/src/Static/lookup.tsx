export  const LOOKUP = {
    WEB_APP_NAME :"Aqua Paths",
    NAVBAR:{
        HOME:"Home",
        NEWS:"News",
        TRACK_VESSEL :"Track Vessel",
        CHECK_CARGO:"Check Cargo",
        About:"About",
        LOGIN:"Login",
        SIGNOUT:"Signout"
    },
    ...
    VIDEO_BACKGROUNDS:{
        LOGIN_BACKGROUND:"https://res.cloudinary.com/dzhlmx3ec/video/upload/v1713036420/pfkdcadlzd2xsfwf1bw0.mp4",
